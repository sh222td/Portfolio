...
namespace Medlemssystem
{
    class Presentation
    {
        ...
        public static void ListMembers()
        {
            ...
            Console.WriteLine("========================================");
            Console.WriteLine("=                                      =");
            Console.WriteLine("=     Lista med alla medlemmar!        =");
            Console.WriteLine("=                                      =");
            Console.WriteLine("========================================\n");
            Console.ResetColor();
        }
        ...
        public static void NoStoredUsers()
        {
            Console.BackgroundColor = ConsoleColor.DarkRed;
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("========================================");
            Console.WriteLine("=                                      =");
            Console.WriteLine("=    Finns inga sparade medlemmar!     =");
            Console.WriteLine("=                                      =");
            Console.WriteLine("========================================\n");
            Console.ResetColor();
        }
        ...
        public static void UserListFulll()
        {
